  ...
  <header class="head_container">
    <div class="head_left">
      ...
      <section v-if="goBack" @click="back">
        <svg viewBox="0 0 15 15" class="goback" width="100%" height="60%" xmlns="http://www.w3.org/2000/svg" version="1.1">
    ...
    <div class="head_right">
      ...
      <router-link :to="'/userinfo'" v-else-if="this.$route.path == '/'" style="touch-action: none;" class="user_avator">
      ...
      <router-link :to="'/'" v-else>
        <span class="right_text">返回首页</span>
      </router-link>
    </div>
  </header>
</template>
